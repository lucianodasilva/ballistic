...
#include "ballistic.entity_type_reader.h"
...
namespace ballistic {
	...
	void package_loader::register_reader (ballistic::ipackage_element_reader * reader)
	{
		_registered_types [reader->name ()] = reader;
	}
