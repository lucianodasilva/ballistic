#include "ballistic.io.animation_sequence_reader.h"

namespace ballistic {
	namespace io {

		const char * animation_sequence_reader::type () const {
			return "entity_type";
		}

		void animation_sequence_reader::load_component (
		...
		void animation_sequence_reader::load_element (
			const tinyxml2::XMLElement * element,
			ballistic::resource_container & container
			) {
