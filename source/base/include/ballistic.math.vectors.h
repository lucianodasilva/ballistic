...
namespace ballistic {
	...
	typedef math::vectors::vec2_t < int32_t > point;

	typedef math::vectors::vec2_t < real > vec2;
	typedef math::vectors::vec3_t < real > vec3;
	typedef math::vectors::vec4_t < real > vec4;

	typedef math::vectors::vec2_t < int32_t > ivec2;
	typedef math::vectors::vec3_t < int32_t > ivec3;
	typedef math::vectors::vec4_t < int32_t > ivec4;

	typedef math::vectors::vec2_t < uint32_t > uvec2;
	typedef math::vectors::vec3_t < uint32_t > uvec3;
	typedef math::vectors::vec4_t < uint32_t > uvec4;

	typedef math::vectors::vec4_t < real > color;
