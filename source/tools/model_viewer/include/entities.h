...
<<<<<<< Updated upstream:source/frontend/model_viewer/include/entities.h
...
=======
		cam_props [ballistic::id::graphics::projection] = string ("perspective");
		cam_props [ballistic::id::graphics::fov] = real (45);
		cam_props [ballistic::id::graphics::near] = real (.1);
		cam_props [ballistic::id::graphics::far] = real (100.0);
>>>>>>> Stashed changes:source/tools/model_viewer/include/entities.h

		auto & entity_props = camera_type->properties;
		entity_props [ballistic::id::position] = vec3{.0, .0, 50.};
		entity_props [ballistic::id::target] = vec3 {.0, .0, .0};
		entity_props [ballistic::id::up] = vec3 {.0, 1., .0};
	}
...
=======
		fps_props [ballistic::id::transform_position] = vec3{-.9, .9, .0};
		fps_props [ballistic::id::transform_scale] = vec3{.05, .05, .05};
		fps_props [ballistic::id::graphics::text::font_id] = text_to_id ("consolas_16.font");
>>>>>>> Stashed changes:source/tools/model_viewer/include/entities.h
	}
