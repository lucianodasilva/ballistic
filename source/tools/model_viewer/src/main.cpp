...
<<<<<<< Updated upstream:source/frontend/model_viewer/src/main.cpp
		model->properties [id::visual::mesh] = mesh;
		model->properties [id::visual::material] = material;
=======
		model->properties [ballistic::id::graphics::mesh] = mesh;
		model->properties [ballistic::id::graphics::material] = material;
>>>>>>> Stashed changes:source/tools/model_viewer/src/main.cpp
...
<<<<<<< Updated upstream:source/frontend/model_viewer/src/main.cpp
		...
		light->properties [id::light::fallout] = real (camera_radius * 2.0);
=======
		light->properties [ballistic::id::position] = vec3{camera_radius, camera_radius, .0};
		light->properties [ballistic::id::graphics::light_color] = color {0.1, 0.5, 1., 1.};
		light->properties [ballistic::id::graphics::light_fallout] = real (camera_radius * 2.0);

		light = g.entities.create (light_entity_type);
		light->properties [ballistic::id::position] = vec3{camera_radius, .0, camera_radius};
		light->properties [ballistic::id::graphics::light_color] = color{1.0, 1.0, 1., 1.};
		light->properties [ballistic::id::graphics::light_fallout] = real (camera_radius * 2.0);

		light = g.entities.create (light_entity_type);
		light->properties [ballistic::id::position] = vec3{-camera_radius, -camera_radius, .0};
		light->properties [ballistic::id::graphics::light_color] = color{0.1, 0.1, 0.0, 0.25};
		light->properties [ballistic::id::graphics::light_fallout] = real (camera_radius * 2.0);
>>>>>>> Stashed changes:source/tools/model_viewer/src/main.cpp
